...
public final class resourceNotFound_jspx extends org.apache.jasper.runtime.HttpJspBase
...
static {
  ...
  private boolean _jspx_meth_util_panel_0(PageContext _jspx_page_context)
    ...
    _jspx_th_util_panel_0.setJspBody(new resourceNotFound_jspxHelper( 0, _jspx_page_context, _jspx_th_util_panel_0, null));
  ...
  private boolean _jspx_meth_spring_message_1(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_spring_message_1.setCode("error_resourcenotfound_problemdescription");
  ...
  private boolean _jspx_meth_c_if_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${not empty exception}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    ...
    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        if (_jspx_meth_spring_message_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_0, _jspx_page_context))
          return true;
        if (_jspx_meth_util_panel_1((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_0, _jspx_page_context))
          return true;
        if (_jspx_meth_spring_message_4((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_0, _jspx_page_context))
          return true;
        if (_jspx_meth_util_panel_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_0, _jspx_page_context))
          return true;
        out.write("</p>");
  ...
  private boolean _jspx_meth_spring_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_spring_message_2.setCode("exception_details");
  ...
  private boolean _jspx_meth_util_panel_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  util:panel
    org.apache.jsp.tag.web.util.panel_tagx _jspx_th_util_panel_1 = (_jspx_resourceInjector != null) ? _jspx_resourceInjector.createTagHandlerInstance(org.apache.jsp.tag.web.util.panel_tagx.class) : new org.apache.jsp.tag.web.util.panel_tagx();
    _jspx_th_util_panel_1.setJspContext(_jspx_page_context);
    _jspx_th_util_panel_1.setParent(_jspx_th_c_if_0);
    _jspx_th_util_panel_1.setOpenPane("false");
    _jspx_th_util_panel_1.setTitle((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${message}", java.lang.String.class, (PageContext)_jspx_page_context, null));
    _jspx_th_util_panel_1.setId("_message");
    _jspx_th_util_panel_1.setJspBody(new resourceNotFound_jspxHelper( 1, _jspx_page_context, _jspx_th_util_panel_1, null));
    _jspx_th_util_panel_1.doTag();
    return false;
  }
  ...
  private boolean _jspx_meth_c_out_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_c_out_0.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${exception.localizedMessage}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_util_panel_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  util:panel
    org.apache.jsp.tag.web.util.panel_tagx _jspx_th_util_panel_2 = (_jspx_resourceInjector != null) ? _jspx_resourceInjector.createTagHandlerInstance(org.apache.jsp.tag.web.util.panel_tagx.class) : new org.apache.jsp.tag.web.util.panel_tagx();
    _jspx_th_util_panel_2.setJspContext(_jspx_page_context);
    _jspx_th_util_panel_2.setParent(_jspx_th_c_if_0);
    _jspx_th_util_panel_2.setOpenPane("false");
    _jspx_th_util_panel_2.setTitle((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${stacktrace}", java.lang.String.class, (PageContext)_jspx_page_context, null));
    _jspx_th_util_panel_2.setId("_exception");
    _jspx_th_util_panel_2.setJspBody(new resourceNotFound_jspxHelper( 2, _jspx_page_context, _jspx_th_util_panel_2, null));
    _jspx_th_util_panel_2.doTag();
    return false;
  }
  ...
  private boolean _jspx_meth_c_forEach_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${exception.stackTrace}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_out_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_out_1.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${trace}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private class resourceNotFound_jspxHelper
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
    ...
    {
      out.write("<h2>");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${fn:escapeXml(title)}", java.lang.String.class, (PageContext)_jspx_page_context, _jspx_fnmap_0));
      out.write("</h2>");
      out.write("<p>");
    ...
    public boolean invoke1( JspWriter out ) 
      throws Throwable
    {
      if (_jspx_meth_c_out_0((javax.servlet.jsp.tagext.JspTag) _jspx_parent, _jspx_page_context))
        return true;
      return false;
    }
